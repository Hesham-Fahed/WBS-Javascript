    ...
    window.addEventListener("load", function () {
        ...
        function bearbeiten(e) {
            ...
            if (a.nodeName.toLowerCase() === "a" && a.innerHTML.toLowerCase() === "bearbeiten") {
                ...
                var eintrag = document.getElementById("eintrag"); // Das input-feld
                var txt = li.childNodes[4].nodeValue.trim();      // spricht den Textknoten an, der geändert werden soll
                eintrag.value = txt;    // überträgt den alten Text ins Ändern-Feld
                div_bearbeiten.style.display = "block";
                bearbeitet = li; //Pointer auf li das bearbeitet wird, wird ausserhalb der Funktion weiterverwendet
            }
        }
...
//                         break;
//                     case "verschieben":
//                         var parentUl = a.parentElement.parentElement;
//                         var parentLi= a.parentElement;
//                         var targetUl;
//                         if(parentUl.id.indexOf("oben")>-1) {
//                             targetUl = ul[1];
//                         } else {
//                             targetUl = ul[0]; 
//                         }
