...
html += "kurs //=> " + kurs + "<br>";
html += "kurs.title //=> " + kurs.title + "<br>";
html += "kurs.num //=> " + kurs.num + "<br>";
html += "kurs.description //=> " + kurs.description + "<br>";
html += "kurs.places //=> " + kurs.places + "<br>";
html += "kurs.members //=> " + kurs.members + "<br>";
...
//JSON-Notation: Eigenschaften als Strings angeben
var o = {
    "eigenschaft1" : "Hallo",
    "eigenschaft2" : "Welt"
}

//JSON Notation erlaubt solche Eigenschaftsnamen...
var o = {
    "das ist kein guter Index Name" : "Hallo"
}
//...bei diesem Eigenschaftsnamen geht nur die arrayartige Notaton:
console.log(o["das ist kein guter Index Name"]);
