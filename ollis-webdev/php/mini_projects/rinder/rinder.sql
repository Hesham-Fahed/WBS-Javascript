...
INSERT INTO `friend_requests` (`user1`, `user2`) VALUES
(6, 1),
(3, 4),
(2, 5),
(3, 5);
...
INSERT INTO `users` (`id`, `email`, `password`, `screenname`, `portrait`, `gender`, `registered`) VALUES
(1, 'a@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Cattle McCowster', 'img/avatars/1.jpg', 1, '2015-06-02 05:00:00'),
(2, 'b@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Mustafa Ibrahim', 'img/avatars/2.jpg', 1, '2017-06-14 07:00:00'),
(3, 'c@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'The Cheesemaker', 'img/avatars/3.jpg', 4, '2017-06-17 00:00:00'),
(4, 'd@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Udder Nonsense', 'img/avatars/4.jpg', 3, '2016-06-17 00:00:00'),
(5, 'e@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Helga the mighty Supercow', 'img/avatars/5.jpg', 2, '2017-08-27 00:00:00'),
(6, 'f@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Karl', 'img/avatars/6.jpg', 2, '2017-06-05 00:00:00'),
(7, 'g@moo.de', '$2y$10$b0f9vaaiBcjJSq1UpdbrdOLtaYWLeY.mSXLZF2KLcQ2R7uUauLXDe', 'Buttermilk', 'img/avatars/default.jpg', 3, '2017-07-06 00:00:00');
...
--
ALTER TABLE `friends`
  ADD CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`user1`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `friends_ibfk_2` FOREIGN KEY (`user2`) REFERENCES `users` (`id`);

--
-- Constraints for table `friend_requests`
--
ALTER TABLE `friend_requests`
  ADD CONSTRAINT `friend_requests_ibfk_1` FOREIGN KEY (`user1`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `friend_requests_ibfk_2` FOREIGN KEY (`user2`) REFERENCES `users` (`id`);
