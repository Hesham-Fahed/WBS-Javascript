...
<input type="hidden" name="token" value="<?=$token?>" >
    ...
    <input type="submit" class="btn btn-danger " value="Senden" name="btn"> <?= (isset($_POST['btn']) && empty($errors)) ? sendmail($_POST):"" ?>
    </fieldset>
